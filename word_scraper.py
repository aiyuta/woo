...
def grok(input, input_key):
    ...
    try:
        ...
        return f"Exception when calling Grok API: {str(e)}"
        ...
        try:
            with open("word_data.json") as f: 
                ...
                if keyword in data:
                    ...
                    try:
                        response = grok(prompts,"xai-dsGhWxaal2XP7ywNePHrhnKXil9N5ZXhKSvzdG9Zw6imLimqR5IftzV5nt1b4MRBkNPQUCawPpX7xeab")
