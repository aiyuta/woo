            ...
            with open("word_data.json") as f: 
                ...
                if keyword in data:
                    ...
                    if len(len_keyword) == 1:
                        lookup = "You are a kind helpful dictionary assistant.return me with the following format:  ## Phonetic: /n $phonetic /n##Explanation: /n$explanation /n## Sentences:/n$5 sentences "  
                    else:
